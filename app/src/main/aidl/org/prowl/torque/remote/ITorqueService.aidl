...
interface ITorqueService {
   ...
   */
   ...
   /**
    * Add / Update a PID from your plugin to the settings_activity app, Your PID is keyed by name.
    *
  ...
  /**
   ...
   /**
    * Translate a string that *might* be in translation file in the settings_activity Torque app. Do not call this method repeatedly for the same text!
    */
   ...
   /**
    * Add / Update a PID from your plugin to the settings_activity app, Your PID is keyed by name.  This can be used to set a value on a PID in Torque.
    *
